---
name: obs:init
description: Initialize observability contracts in the current project. Creates contracts/, evals/, hooks/, canonical dictionaries, tests/, scratch/ with full @observable enforcement and TDD structure.
...
- `~/.claude/obs-templates/evals/check_dictionaries.py`
...
- `~/.claude/obs-templates/function-dictionary.md`
- `~/.claude/obs-templates/file-dictionary.md`
...
| `evals/check_dictionaries.py` | `evals/check_dictionaries.py` |
...
| `function-dictionary.md` | `function-dictionary.md` |
| `file-dictionary.md` | `file-dictionary.md` |
...
This should show that the canonical dictionaries match the empty production code.

Then verify that the canonical dictionaries exist:
...
Next steps:
  ...
  3. Hooks or /agent enforce compliance after every edit
  4. Keep function-dictionary.md and file-dictionary.md updated with each change
```
